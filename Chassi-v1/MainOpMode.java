...
public class MainOpMode extends OpMode
{
    ...
    public void runTeleOpControls() {
        ...
        // Set left and right motors power with two stick
        ...
        // Set the arm motors power with one button
        if(gamepad1.a) {
            armMotorOnePower = 1;
            armMotorTwoPower = 1;
        } else {
        ...
        // Set the arm claw position with one button
        if(gamepad1.b && clawServoPosition == 0) {
            clawServoPosition = 1;
        } else if (gamepad1.b){
            clawServoPosition = 0;
        }
    ...
    public void showTelemetry() {
        ...
        telemetry.addData("Arm Motors", "one (%.2f), two (%.2f)", armMotorOnePower, armMotorTwoPower);
        telemetry.addData("Servos Posi", "claw (%.2f), arm (%.2f)", leftMotorPower, rightMotorPower);
        telemetry.update();
