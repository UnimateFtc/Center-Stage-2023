...
public class AutonomousModeBlueDown extends OpMode
{
    ...
    public void start() {
        ...
        TwoMotorsRunToPosition(leftMotor, rightMotor, ConvertCentimeterToTick(192));
    }
    ...
    public void initPixelsServo() {
        pixelServo = hardwareMap.get(Servo.class, "servoOuttake");
